// data for the file
const runsData = {
    "City": ["Abu Dhabi", "Ahmedabad", "Bangalore", "Bloemfontein", "Cape Town", "Centurion", "Chandigarh", "Chennai", "Cuttack", "Delhi", "Dharamsala", "Dubai International Cricket Stadium", "Durban", "East London", "Hyderabad", "Indore", "Jaipur", "Johannesburg", "Kanpur", "Kimberley", "Kochi", "Kolkata", "Mumbai", "Nagpur", "Port Elizabeth", "Pune", "Raipur", "Rajkot", "Ranchi", "Sharjah Cricket Stadium", "Visakhapatnam"],
...
// map loading
var mymap = L.map('issMap', { minZoom: 2 }).setView([4, 65], 2.5);
...
function teamChosen(name, col) {
    function mapBubble(num) {
        if (runsData[name][num] > 0) {
            L.circle([runsData.lat[num], runsData.long[num]], {
                color: col,
                fillColor: col,
                fillOpacity: 0.5,
    ...
    var abuDhabi = mapBubble(0);
    var ahmedabad = mapBubble(1);
    var bangalore = mapBubble(2);
    var bloemfontein = mapBubble(3);
    var capeTown = mapBubble(4);
    var centurion = mapBubble(5);
    var chandigarh = mapBubble(6);
    var chennai = mapBubble(7);
    var cuttack = mapBubble(8);
    var delhi = mapBubble(9);
    var dharamshala = mapBubble(10);
    var dubai = mapBubble(11);
    var durban = mapBubble(12);
    var eastLondon = mapBubble(13);
    var hyderabad = mapBubble(14);
    var indore = mapBubble(15);
    var jaipur = mapBubble(16);
    var johannesburg = mapBubble(17);
    var kanpur = mapBubble(18);
    var kimberley = mapBubble(19);
    var kochi = mapBubble(20);
    var kolkata = mapBubble(21);
    var mumbai = mapBubble(22);
    var nagpur = mapBubble(23);
    var portElizabeth = mapBubble(24);
    var pune = mapBubble(25);
    var raipur = mapBubble(26);
    var rajkot = mapBubble(27);
    var ranchi = mapBubble(28);
    var sharjah = mapBubble(29);
    var vishakhapatnam = mapBubble(30);

    venues = L.layerGroup([abuDhabi, ahmedabad, bangalore, bloemfontein, capeTown, centurion, chandigarh, chennai, cuttack, delhi, dharamshala, dubai, durban, eastLondon, hyderabad, indore, jaipur, johannesburg, kanpur, kimberley, kochi, kolkata, mumbai, nagpur, portElizabeth, pune, raipur, rajkot, ranchi, sharjah, vishakhapatnam]);
};
